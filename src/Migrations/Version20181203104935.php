 ...
 */
final class Version20181203104935 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE car_seat DROP FOREIGN KEY car_seat_ibfk_1');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE car_seat ADD CONSTRAINT car_seat_ibfk_1 FOREIGN KEY (car_id) REFERENCES car (id)');
    }
}
